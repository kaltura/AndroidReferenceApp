...
public abstract class KalturaAssetParamsOutputBaseFilter extends KalturaAssetParamsFilter {
    ...
    public KalturaAssetParamsOutputBaseFilter(Element node) throws KalturaApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("assetParamsIdEqual")) {
                this.assetParamsIdEqual = ParseUtils.parseInt(txt);
                continue;
            } else if (nodeName.equals("assetParamsVersionEqual")) {
                this.assetParamsVersionEqual = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("assetIdEqual")) {
                this.assetIdEqual = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("assetVersionEqual")) {
                this.assetVersionEqual = ParseUtils.parseString(txt);
                continue;
    ...
    public KalturaParams toParams() {
        ...
        kparams.add("assetParamsVersionEqual", this.assetParamsVersionEqual);
        kparams.add("assetIdEqual", this.assetIdEqual);
        kparams.add("assetVersionEqual", this.assetVersionEqual);
