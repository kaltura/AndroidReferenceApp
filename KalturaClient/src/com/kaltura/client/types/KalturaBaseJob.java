...
public class KalturaBaseJob extends KalturaObjectBase {
    public int id = Integer.MIN_VALUE;
    public int partnerId = Integer.MIN_VALUE;
    public int createdAt = Integer.MIN_VALUE;
    public int updatedAt = Integer.MIN_VALUE;
    public int deletedAt = Integer.MIN_VALUE;
    public int processorExpiration = Integer.MIN_VALUE;
    ...
    public KalturaBaseJob(Element node) throws KalturaApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("id")) {
                ...
                continue;
            } else if (nodeName.equals("processorExpiration")) {
                this.processorExpiration = ParseUtils.parseInt(txt);
                continue;
    ...
    public KalturaParams toParams() {
        ...
        kparams.add("objectType", "KalturaBaseJob");
        return kparams;
    }
