...
public abstract class KalturaFileSyncBaseFilter extends KalturaFilter {
    ...
    public float fileSizeGreaterThanOrEqual = Float.MIN_VALUE;
    public float fileSizeLessThanOrEqual = Float.MIN_VALUE;
    ...
    public KalturaFileSyncBaseFilter(Element node) throws KalturaApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("partnerIdEqual")) {
                ...
                this.fileSizeGreaterThanOrEqual = ParseUtils.parseFloat(txt);
                continue;
            } else if (nodeName.equals("fileSizeLessThanOrEqual")) {
                this.fileSizeLessThanOrEqual = ParseUtils.parseFloat(txt);
                continue;
            } 
        }
    }
