...
public class KalturaMailJob extends KalturaBaseJob {
    ...
    public int culture = Integer.MIN_VALUE;
    ...
    public KalturaMailJob(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("mailType")) {
                ...
                this.culture = ParseUtils.parseInt(txt);
                continue;
    ...
    public KalturaParams toParams() {
        ...
        kparams.add("objectType", "KalturaMailJob");
        ...
        kparams.add("culture", this.culture);
