 ...
 */
public enum KalturaNotificationOrderBy implements KalturaEnumAsString {
    ...
    KalturaNotificationOrderBy(String hashCode) {
    ...
    public static KalturaNotificationOrderBy get(String hashCode) {
