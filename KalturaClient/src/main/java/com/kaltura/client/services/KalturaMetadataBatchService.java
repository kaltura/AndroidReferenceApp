...
public class KalturaMetadataBatchService extends KalturaServiceBase {
    public KalturaMetadataBatchService(KalturaClient client) {
        this.kalturaClient = client;
    }

    public List<KalturaBatchJob> getExclusiveTransformMetadataJobs(KalturaExclusiveLockKey lockKey, int maxExecutionTime, int numberOfJobs) throws KalturaApiException {
        return this.getExclusiveTransformMetadataJobs(lockKey, maxExecutionTime, numberOfJobs, null);
    }

	/**  batch getExclusiveTransformMetadataJob action allows to get a BatchJob of type
	  METADATA_TRANSFORM      */
    public List<KalturaBatchJob> getExclusiveTransformMetadataJobs(KalturaExclusiveLockKey lockKey, int maxExecutionTime, int numberOfJobs, KalturaBatchJobFilter filter) throws KalturaApiException {
        ...
        this.kalturaClient.queueServiceCall("metadata_metadatabatch", "getExclusiveTransformMetadataJobs", kparams);
    ...
    public KalturaTransformMetadataResponse getTransformMetadataObjects(int metadataProfileId, int srcVersion, int destVersion) throws KalturaApiException {
        return this.getTransformMetadataObjects(metadataProfileId, srcVersion, destVersion, null);
    }

	/**  batch getTransformMetadataObjects action retrieve all metadata objects that
	  requires upgrade and the total count      */
    public KalturaTransformMetadataResponse getTransformMetadataObjects(int metadataProfileId, int srcVersion, int destVersion, KalturaFilterPager pager) throws KalturaApiException {
        KalturaParams kparams = new KalturaParams();
        kparams.add("metadataProfileId", metadataProfileId);
        kparams.add("srcVersion", srcVersion);
        kparams.add("destVersion", destVersion);
        kparams.add("pager", pager);
        this.kalturaClient.queueServiceCall("metadata_metadatabatch", "getTransformMetadataObjects", kparams);
        if (this.kalturaClient.isMultiRequest())
            return null;
        Element resultXmlElement = this.kalturaClient.doQueue();
        return ParseUtils.parseObject(KalturaTransformMetadataResponse.class, resultXmlElement);
    }
    ...
    public KalturaBulkUploadResult addBulkUploadResult(KalturaBulkUploadResult bulkUploadResult, ArrayList<KalturaBulkUploadPluginData> pluginDataArray) throws KalturaApiException {
        ...
        this.kalturaClient.queueServiceCall("metadata_metadatabatch", "addBulkUploadResult", kparams);
        if (this.kalturaClient.isMultiRequest())
            return null;
        Element resultXmlElement = this.kalturaClient.doQueue();
    ...
    public KalturaBulkUploadResult getBulkUploadLastResult(int bulkUploadJobId) throws KalturaApiException {
        ...
        this.kalturaClient.queueServiceCall("metadata_metadatabatch", "getBulkUploadLastResult", kparams);
        if (this.kalturaClient.isMultiRequest())
            return null;
        Element resultXmlElement = this.kalturaClient.doQueue();
        return ParseUtils.parseObject(KalturaBulkUploadResult.class, resultXmlElement);
    ...
    public int countBulkUploadEntries(int bulkUploadJobId, KalturaBulkUploadObjectType bulkUploadObjectType) throws KalturaApiException {
        ...
        this.kalturaClient.queueServiceCall("metadata_metadatabatch", "countBulkUploadEntries", kparams);
        if (this.kalturaClient.isMultiRequest())
            return 0;
        Element resultXmlElement = this.kalturaClient.doQueue();
    ...
    public int updateBulkUploadResults(int bulkUploadJobId) throws KalturaApiException {
        KalturaParams kparams = new KalturaParams();
        kparams.add("bulkUploadJobId", bulkUploadJobId);
        this.kalturaClient.queueServiceCall("metadata_metadatabatch", "updateBulkUploadResults", kparams);
        if (this.kalturaClient.isMultiRequest())
            return 0;
        Element resultXmlElement = this.kalturaClient.doQueue();
        String resultText = resultXmlElement.getTextContent();
    ...
    public KalturaBatchJob updateExclusiveConvertCollectionJob(int id, KalturaExclusiveLockKey lockKey, KalturaBatchJob job, ArrayList<KalturaConvertCollectionFlavorData> flavorsData) throws KalturaApiException {
        ...
        this.kalturaClient.queueServiceCall("metadata_metadatabatch", "updateExclusiveConvertCollectionJob", kparams);
        if (this.kalturaClient.isMultiRequest())
            return null;
        Element resultXmlElement = this.kalturaClient.doQueue();
    ...
    public KalturaBatchJob updateExclusiveConvertJobSubType(int id, KalturaExclusiveLockKey lockKey, int subType) throws KalturaApiException {
        ...
        this.kalturaClient.queueServiceCall("metadata_metadatabatch", "updateExclusiveConvertJobSubType", kparams);
        if (this.kalturaClient.isMultiRequest())
            return null;
        Element resultXmlElement = this.kalturaClient.doQueue();
        return ParseUtils.parseObject(KalturaBatchJob.class, resultXmlElement);
    ...
    public KalturaMediaInfo addMediaInfo(KalturaMediaInfo mediaInfo) throws KalturaApiException {
        ...
        this.kalturaClient.queueServiceCall("metadata_metadatabatch", "addMediaInfo", kparams);
        if (this.kalturaClient.isMultiRequest())
            return null;
        Element resultXmlElement = this.kalturaClient.doQueue();
    ...
    public KalturaBatchGetExclusiveNotificationJobsResponse getExclusiveNotificationJobs(KalturaExclusiveLockKey lockKey, int maxExecutionTime, int numberOfJobs, KalturaBatchJobFilter filter) throws KalturaApiException {
        ...
        kparams.add("numberOfJobs", numberOfJobs);
        kparams.add("filter", filter);
        this.kalturaClient.queueServiceCall("metadata_metadatabatch", "getExclusiveNotificationJobs", kparams);
        if (this.kalturaClient.isMultiRequest())
            return null;
        Element resultXmlElement = this.kalturaClient.doQueue();
    ...
    public void resetJobExecutionAttempts(int id, KalturaExclusiveLockKey lockKey, KalturaBatchJobType jobType) throws KalturaApiException {
        ...
        this.kalturaClient.queueServiceCall("metadata_metadatabatch", "resetJobExecutionAttempts", kparams);
        if (this.kalturaClient.isMultiRequest())
            return ;
    ...
    public KalturaFreeJobResponse freeExclusiveJob(int id, KalturaExclusiveLockKey lockKey, KalturaBatchJobType jobType, boolean resetExecutionAttempts) throws KalturaApiException {
        ...
        this.kalturaClient.queueServiceCall("metadata_metadatabatch", "freeExclusiveJob", kparams);
        if (this.kalturaClient.isMultiRequest())
            return null;
        Element resultXmlElement = this.kalturaClient.doQueue();
    ...
    public int getQueueSize(KalturaWorkerQueueFilter workerQueueFilter) throws KalturaApiException {
        ...
        this.kalturaClient.queueServiceCall("metadata_metadatabatch", "getQueueSize", kparams);
        if (this.kalturaClient.isMultiRequest())
            return 0;
        Element resultXmlElement = this.kalturaClient.doQueue();
        String resultText = resultXmlElement.getTextContent();
    ...
    public List<KalturaBatchJob> getExclusiveJobs(KalturaExclusiveLockKey lockKey, int maxExecutionTime, int numberOfJobs, KalturaBatchJobFilter filter, KalturaBatchJobType jobType) throws KalturaApiException {
        ...
        kparams.add("filter", filter);
        kparams.add("jobType", jobType);
        this.kalturaClient.queueServiceCall("metadata_metadatabatch", "getExclusiveJobs", kparams);
        if (this.kalturaClient.isMultiRequest())
            return null;
        Element resultXmlElement = this.kalturaClient.doQueue();
        return ParseUtils.parseArray(KalturaBatchJob.class, resultXmlElement);
    ...
    public List<KalturaBatchJob> getExclusiveAlmostDone(KalturaExclusiveLockKey lockKey, int maxExecutionTime, int numberOfJobs, KalturaBatchJobFilter filter, KalturaBatchJobType jobType) throws KalturaApiException {
        ...
        kparams.add("filter", filter);
        kparams.add("jobType", jobType);
        this.kalturaClient.queueServiceCall("metadata_metadatabatch", "getExclusiveAlmostDone", kparams);
        if (this.kalturaClient.isMultiRequest())
            return null;
        Element resultXmlElement = this.kalturaClient.doQueue();
        return ParseUtils.parseArray(KalturaBatchJob.class, resultXmlElement);
    ...
    public KalturaBatchJob updateExclusiveJob(int id, KalturaExclusiveLockKey lockKey, KalturaBatchJob job) throws KalturaApiException {
        ...
        kparams.add("lockKey", lockKey);
        kparams.add("job", job);
        this.kalturaClient.queueServiceCall("metadata_metadatabatch", "updateExclusiveJob", kparams);
        if (this.kalturaClient.isMultiRequest())
            return null;
        Element resultXmlElement = this.kalturaClient.doQueue();
        return ParseUtils.parseObject(KalturaBatchJob.class, resultXmlElement);
    ...
    public int cleanExclusiveJobs() throws KalturaApiException {
        KalturaParams kparams = new KalturaParams();
        this.kalturaClient.queueServiceCall("metadata_metadatabatch", "cleanExclusiveJobs", kparams);
        if (this.kalturaClient.isMultiRequest())
            return 0;
        Element resultXmlElement = this.kalturaClient.doQueue();
        String resultText = resultXmlElement.getTextContent();
    ...
    public void logConversion(String flavorAssetId, String data) throws KalturaApiException {
        ...
        this.kalturaClient.queueServiceCall("metadata_metadatabatch", "logConversion", kparams);
        if (this.kalturaClient.isMultiRequest())
            return ;
        this.kalturaClient.doQueue();
    }
    ...
    public KalturaFileExistsResponse checkFileExists(String localPath, float size) throws KalturaApiException {
        ...
        this.kalturaClient.queueServiceCall("metadata_metadatabatch", "checkFileExists", kparams);
        if (this.kalturaClient.isMultiRequest())
            return null;
        Element resultXmlElement = this.kalturaClient.doQueue();
