...
public class KalturaUploadTokenService extends KalturaServiceBase {
    ...
    public KalturaUploadToken upload(String uploadTokenId, InputStream fileData, String fileDataName, long fileDataSize, boolean resume, boolean finalChunk, float resumeAt) throws KalturaApiException {
        return this.upload(uploadTokenId, new KalturaFile(fileData, fileDataName, fileDataSize), resume, finalChunk, resumeAt);
    }

    public KalturaUploadToken upload(String uploadTokenId, FileInputStream fileData, String fileDataName, boolean resume, boolean finalChunk, float resumeAt) throws KalturaApiException {
    ...
    public KalturaUploadToken upload(String uploadTokenId, KalturaFile fileData, boolean resume, boolean finalChunk, float resumeAt) throws KalturaApiException {
        KalturaParams kparams = new KalturaParams();
        kparams.add("uploadTokenId", uploadTokenId);
