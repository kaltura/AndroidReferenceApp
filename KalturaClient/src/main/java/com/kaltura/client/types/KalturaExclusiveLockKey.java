...
public class KalturaExclusiveLockKey extends KalturaObjectBase {
    ...
    public KalturaExclusiveLockKey(Element node) throws KalturaApiException {
    ...
    public KalturaParams toParams() {
        ...
        kparams.add("objectType", "KalturaExclusiveLockKey");
